...
OPTIONS=["DELHI","NOIDA","GURGAON/GURUGRAM",
        "KANPUR","LUCKNOW","KOLKATA","BANGLORE"]
LOACATION=st.sidebar.multiselect('SELECT LOCATION: ',
                                 options=OPTIONS)
...
apply link and OUTPUT ,ust be in HTML NO MARKDOWN"""
...
if st.button('generate resume'):
  with st.spinner("runnign agent"):
    ...
    job_code=response['messages'][-1]['text']
